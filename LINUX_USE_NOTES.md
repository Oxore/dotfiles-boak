...
Образ можно некоторыми образом изменять и изменения будут сохранены.
Контейнер - это запущенный экземпляр образ.
Запущенный образ можно изменить, но изменения не попадают в образ и сохраняются лишь до тех пор, пока существует контейнер (экземпляр образа).
